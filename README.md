...
## Description
Using an API, this app is intended to allow its users to search for books. The users can log in and save and remove books from their saved books list.

## Installation
First, clone this repo by using the command 
`git clone <git hub repo>` into your terminal. Run `npm install` to install its dependencies.

## Usage
After the installation process, run `npm start`.
